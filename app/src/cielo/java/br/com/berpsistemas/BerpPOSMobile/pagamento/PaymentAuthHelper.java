...
public class PaymentAuthHelper {
    ...
    private static String getPosModel() {
        try {
            ...
            Class<?> buildConfigClass = Class.forName("com.mobile.berpsistemas.BerpPosMobile.BuildConfig");
    ...
    public String getAccessToken(String defaultValue) {
        ...
        if (Objects.equals(BuildConfig.FLAVOR, "cielo")) {

            return Variaveis.getConfiguracao("MOBILE_CIELO_CLIENT_TOKEN", "H8tiTQWi04OyE9YQQQklLDqBHYUrytZk1k6mQsBxHuXlFzvXS1").getValor();
        }
        else{
            return "";
        }
    ...
    public String getClientId(String defaultValue) {
       // return prefs.getString(PREFIX_CLIENT_ID + providerName, defaultValue);
        ...
        if (Objects.equals(BuildConfig.FLAVOR, "cielo")) {
            return Variaveis.getConfiguracao("MOBILE_CIELO_CLIENT_ID","2PI5DICbOwAyHNITv4oUdAH3OwCLPRbt6cBsf37f2NeU3TTtkx").getValor();
