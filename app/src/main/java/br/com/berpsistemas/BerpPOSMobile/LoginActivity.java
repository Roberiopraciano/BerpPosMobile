...
import br.com.berpsistemas.BerpPOSMobile.model.LoginCallback;
    ...
    public void onClick(View view) {
        ...
        efetuarLoginBackground(usuarioInformado, senhaInformada, new LoginCallback() {
            ...
            public void onSuccess() {
                ...
                runOnUiThread(() -> {
                    FancyToast.makeText(getApplicationContext(), "Login realizado com sucesso!", FancyToast.LENGTH_LONG,FancyToast.SUCCESS,false).show();
            ...
            public void onFailure(String error) {
                // Atualiza a UI na thread principal
                runOnUiThread(() -> {
                    FancyToast.makeText(getApplicationContext(), "Erro: " + error, FancyToast.LENGTH_LONG,FancyToast.ERROR,false).show();
                    FancyToast.makeText(LoginActivity.this, "Usuário ou senha inválidos", FancyToast.LENGTH_LONG,FancyToast.ERROR,false).show();
                    edtTxtSenha.setText("");
                });
            }
        });
