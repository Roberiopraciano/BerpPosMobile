...
//    }
    ...
    private void generateAndShareBill() {
        ...
        try {
            ...
            FancyToast.makeText(this, "Conta gerada com sucesso!", FancyToast.LENGTH_LONG,FancyToast.INFO,true).show();
        } catch (IOException e) {
            e.printStackTrace();
            FancyToast.makeText(this, "Erro ao gerar a conta: " + e.getMessage(),FancyToast.LENGTH_LONG, FancyToast.ERROR,true).show();
        }
    }
